...
/**
 * Specific dialog to select the properties to locate in the related container.
 *
 * @author cnotot
 */
public class ComponentsEditorDialog extends FeatureEditorDialog {
    ...
    public ComponentsEditorDialog(Shell parent, ILabelProvider labelProvider, Object object,
    ...
    private boolean isCandidateValue(Object value) {
        return (!unique || !values.getChildren().contains(value)) && value instanceof Property;
    }
