...
/**
 * Entry point of the 'ComponentsOnly' generation module.
 *
 * @generated NOT
 */
public class ComponentsOnly extends Uml2autojava {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/umlgen/gen/autojava/main/componentsOnly";
     ...
     * @generated
     */
    public ComponentsOnly(URI modelURI, File targetFolder, List<? extends Object> arguments)
            throws IOException {
     ...
     * @generated
     */
    public ComponentsOnly(EObject model, File targetFolder, List<? extends Object> arguments)
            throws IOException {
     ...
     */
    public ComponentsOnly(URI modelURI, File targetFolder, List<? extends Object> arguments,
            String sDecorators) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                ComponentsOnly generator = new ComponentsOnly(modelURI, folder, arguments);
