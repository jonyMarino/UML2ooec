...
import org.eclipse.umlgen.dsl.asl.provider.ParameterItemProvider;
import org.eclipse.umlgen.dsl.eth.Container;
import org.eclipse.umlgen.dsl.eth.EthPackage;

/**
 * This is the item provider adapter for a {@link org.eclipse.umlgen.dsl.eth.Container} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_ipAddress_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_ipAddress_feature", "_UI_Container_type"),
				 EthPackage.Literals.CONTAINER__IP_ADDRESS,
				 true,
				 false,
				 false,
	...
	protected void addPortNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_portNumber_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_portNumber_feature", "_UI_Container_type"),
				 EthPackage.Literals.CONTAINER__PORT_NUMBER,
				 true,
				 false,
				 false,
	...
	protected void addComponentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_components_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_components_feature", "_UI_Container_type"),
				 EthPackage.Literals.CONTAINER__COMPONENTS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EthPackage.Literals.CONTAINER__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
