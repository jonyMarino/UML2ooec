...
public class ConfigurationsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ConfigurationsPackage.PROTOCOL_COMMUNICATION: {
				ProtocolCommunication protocolCommunication = (ProtocolCommunication)theEObject;
				T result = caseProtocolCommunication(protocolCommunication);
				if (result == null) result = caseConfiguration(protocolCommunication);
				if (result == null) result = caseDecoration(protocolCommunication);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Protocol Communication</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Protocol Communication</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProtocolCommunication(ProtocolCommunication object) {
		return null;
	}
