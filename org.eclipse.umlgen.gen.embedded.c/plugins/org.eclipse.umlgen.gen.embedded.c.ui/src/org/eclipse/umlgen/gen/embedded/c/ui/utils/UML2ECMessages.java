 ...
 *******************************************************************************/
package org.eclipse.umlgen.gen.embedded.c.ui.utils;
...
/**
 * Utility class to access externalized Strings throughout the UML to Embedded C generator UI.
 */
public final class UML2ECMessages {

    /** Path to the properties file where keys are defined. */
    private static final String BUNDLE_NAME = "org.eclipse.umlgen.gen.embedded.c.ui.utils.messages"; //$NON-NLS-1$
