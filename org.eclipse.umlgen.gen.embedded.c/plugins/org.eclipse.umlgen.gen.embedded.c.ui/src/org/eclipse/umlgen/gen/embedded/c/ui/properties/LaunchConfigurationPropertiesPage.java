 ...
 * this class has been re-used from org.eclipse.umlgen.gen.java.ui. The name of the members and the body of
 * the method <b>handleApplyPressed</b> of the class have been adapted for the sake of the UML to Embedded C
 * generation (the method now manages the case when storedLaunchConfig is null).
 */
public class LaunchConfigurationPropertiesPage extends PropertyPage {
    ...
    /** The viewer to edit a launch configuration for Embededd C generation. */
    ...
    protected Control createContents(Composite parent) {
        ...
        // Create the combo to choose the launch configuration to edit and to select for the Embedded C
        // generation.
    ...
    /**
     * Create a working copy of launch configuration for Embedded C generation.
     *
    ...
    private ILaunchConfigurationWorkingCopy createLaunchConfigurationWorkingCopy() throws CoreException {
        ...
        // Kind of launch configurations for Embedded C generation.
    ...
    private class CustomLaunchConfigurationTabGroupViewer extends LaunchConfigurationTabGroupViewer {
        ...
        protected ILaunchConfiguration handleApplyPressed() {
            ...
            if (launchConfig != null && !combo.getText().equals(launchConfig.getName())) {
                ...
                // storedLaunchConfig may be null
                if (storedLaunchConfig == null) {
                    combo.select(launchConfig);
                    combo.updateCurrentItem(launchConfig);
                } else {
