...
public class Uml2ec extends AbstractAcceleoGenerator {
    ...
    /**
     * The current configuration holder associated with the model.
     *
     * @generated NOT
     */
     ...
     * @generated
     */
    public Uml2ec(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
     ...
     * @generated
     */
    public Uml2ec(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Uml2ec generator = new Uml2ec(modelURI, folder, arguments);
     ...
     *
     * @param aConfigurationHolder
     *            The configuration holder.
     * @generated NOT
     */
    public void setConfigurationHolder(ConfigurationHolder aConfigurationHolder) {
        if (this.model != null) {
            configurationHolder = aConfigurationHolder;
        }
    }

    /**
     * Get the current configuration holder.
     *
     * @return The current configuration holder.
     * @generated NOT
     */
