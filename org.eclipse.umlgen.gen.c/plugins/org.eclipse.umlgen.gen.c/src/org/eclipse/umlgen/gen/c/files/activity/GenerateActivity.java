 ...
 *******************************************************************************/
package org.eclipse.umlgen.gen.c.files.activity;
...
/**
 * Entry point of the 'GenerateActivity' generation module.
 *
 * @generated
 */
public class GenerateActivity extends AbstractAcceleoGenerator {
    /**
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateActivity generator = new GenerateActivity(modelURI, folder, arguments);
