...
public abstract class AbstractReconciler implements IReconciler {
	...
	/**
	 * @see org.eclipse.umlgen.reverse.c.reconciler.IReconciler#notifyListeners(org.eclipse.umlgen.reverse.c.event.CModelChangedEvent,
	 *      boolean)
	 */
	public void notifyListeners(CModelChangedEvent event, boolean needSave) {
		if (event != null) {
