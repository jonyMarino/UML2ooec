 ...
 */
public class TypeDefStructRemoved extends AbstractTypeDefStructEvent {
     ...
     */
    public static AbstractBuilder<TypeDefStructRemoved> builder() {
        return new AbstractBuilder<TypeDefStructRemoved>() {
