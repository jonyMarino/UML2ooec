 ...
 */
public class TypeDefStructRenamed extends AbstractTypeDefStructEvent {
     ...
     */
    public static AbstractBuilder<TypeDefStructRenamed> builder() {
        return new AbstractBuilder<TypeDefStructRenamed>() {
